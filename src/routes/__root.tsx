...
import { SiteContentProvider, siteContentQueryOptions } from "../lib/content";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  loader: ({ context }) => {
    void context.queryClient.ensureQueryData(siteContentQueryOptions);
  },
  head: () => ({
    meta: [
      { charSet: "utf-8" },
...
function RootShell({ children }: { children: ReactNode }) {
  // The theme bootstrap script sets the `dark` class before hydration.
  return (
